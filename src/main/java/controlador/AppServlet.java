...
public class AppServlet extends HttpServlet {
    ...
    private static final String URI_SHOW = "WEB-INF/pages/alumnos/mostrarAlumno.jsp";
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        switch (laAccion) {
            ...
            case "show":
                alu = model.getAlumno(id);
                req.setAttribute("alumnoAMostrar", alu);
                req.setAttribute("idAlumno",id);
                req.setAttribute("noTieneFoto", alu.getFoto().contains("no-face"));
                req.getRequestDispatcher(URI_SHOW).forward(req, resp);
                break;
            default:
